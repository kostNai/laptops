        ...
        <section className="mt-8 flex gap-8 h-2/3 max-lg:flex-col max-lg:h-screen max-lg:gap-2">
            <div className="flex-1 flex flex-col gap-8 pt-16">
                ...
                <p>
                    ...
                    Inventore iste minima ut, et aliquid dolorem quidem
                    perspiciatis vel iure? Quis, quidem consequuntur temporibus
                    architecto perspiciatis nihil? Magni quaerat deleniti
                    quidem.
                </p>
            ...
            <div className="relative flex-1 flex justify-center px-32 py-16 max-xl:p-0 h-full max-lg:h-1/2 max-md:hidden">
